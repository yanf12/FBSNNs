            ...
            if it % 5000 == 0:
                ...
                for i in range(10):
                    for j in range(10):
                        ...
                        Ex
                        act_price_surface[i,j] = self.theoretical_vanilla_eu(S0=S_mesh[i,j], K=1, T=1-t_mesh[i,j], r=0.05, sigma=0.4, type_='call')
                        print (Exact_price_surface[i,j])
